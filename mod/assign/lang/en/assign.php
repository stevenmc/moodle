...
$string['applyattemptpenalty'] = 'Apply Attempt Penalty';
...
$string['attemptpenalty'] = 'Attempt Penalty';
$string['attemptpenalty_help'] = 'Penalise the user by % for this attempt';
...
$string['penaltyapplied'] = '({$a}% penalty applied to grade)';
