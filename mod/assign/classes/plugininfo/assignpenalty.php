...
class assignpenalty extends base {
    /**
    ...
    public static function get_enabled_plugins() {
        ...
        foreach ($plugins as $plugin => $version) {
            $installed[] = 'assignpenalty_'.$plugin;
        }
    ...
    public static function get_manage_url() {
        return new moodle_url('/mod/assign/adminmanageplugins.php', array('subtype'=>'assignpenalty'));
    }
    ...
    public function uninstall_cleanup() {
        ...
        $DB->delete_records('assign_plugin_config', array('plugin'=>$this->name, 'subtype'=>'assignpenalty'));
