...
function xmldb_assign_upgrade($oldversion) {
    ...
    if ($oldversion < 2018012200) {
        ...
        // Define field attemptpenalties to be added to assign.
        $table = new xmldb_table('assign');
        $field = new xmldb_field('latepenalty', XMLDB_TYPE_CHAR, '255', null, null, null, null, 'attemptpenalties');
        ...
        $table = new xmldb_table('assign_grades');
        $field = new xmldb_field('latepenalty', XMLDB_TYPE_CHAR, '255', null, null, null, null, 'attemptpenalty');
        //$field = new xmldb_field('attemptpenalty', XMLDB_TYPE_INTEGER, '3', null, XMLDB_NOTNULL, null, '0', 'attemptnumber');
        ...
        // Assign savepoint reached.
        upgrade_mod_savepoint(true, 2018012200, 'assign');
    }
